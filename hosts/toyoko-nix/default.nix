...
# SOPS stuff I need to add later on
...
#    sops.secrets."wireguard_connection_1_routes_full" = { };
...
#    sops.secrets."wireless_connection_hotspot" = { };
    ...
    environment = {
      ...
      shellAliases.rebuild = "sudo rm -rf /tmp/dotfiles && sudo git clone --branch 0.0.5 https://github.com/starrwulfe/nixos-config /tmp/dotfiles && sudo nixos-rebuild switch --flake /tmp/dotfiles/.#toyoko-nix --impure";
    };
